...
namespace FoodApp.Services.Identity.API.Certificates
{
    static class Certificate
    {
        public static X509Certificate2 Get()
        {
            ...
            using (var stream = assembly.GetManifestResourceStream("FoodApp.Services.Identity.API.Certificate.idsrv3test.pfx"))
            {
